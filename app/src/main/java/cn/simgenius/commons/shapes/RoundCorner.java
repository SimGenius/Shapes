...
public class RoundCorner extends StateListDrawable {
    ...
    float density = new DisplayMetrics().density;
    int normalColor;
    int pressedColor;
    float radiusDp;

    public RoundCorner(int normalColor, int pressedColor, float radiusDp) {
        super();
    ...
    public RoundCorner(String normalColorString, String pressedColorString, float radiusDp) {
        super();
